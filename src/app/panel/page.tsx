    ...
    tasksForPDF.forEach((task, i) => {
      ...
      win.document.write(`
        <div class="task-item">
          ...
          <div class="solution-block"><span class="block-title">✅ Çözüm</span>${task.devNote ? task.devNote.replace(/\*\*ERPIDE Dev Notu:\*\*/gi, "").replace(/\*\*(.+?)\*\*/g, "$1").replace(/\*(.+?)\*/g, "$1").replace(/`(.+?)`/g, "$1").trim() : "<em style='color:#999'>Çözüm bekleniyor</em>"}</div>
          <div class="field">
