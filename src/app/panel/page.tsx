  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6">
      ...
      >
        ...
        <h1 className="text-2xl font-bold mb-2">Musteri Paneli</h1>
        <p className="text-gray-400 text-sm mb-6">Proje durumu, task takibi ve raporlar</p>
        <div className="space-y-3">
          <input placeholder="Musteri Kodu" className="w-full px-4 py-3 rounded-xl bg-black/50 border border-white/10 text-white placeholder-gray-500 focus:border-blue-500 focus:outline-none" />
