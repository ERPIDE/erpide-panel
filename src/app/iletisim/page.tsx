      ...
      <main className="pt-24 pb-16 px-6 min-h-screen">
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold mb-4"><span className="gradient-text">Iletisim</span></h1>
            <p className="text-gray-400">Size nasil yardimci olabiliriz?</p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-5 gap-10">
            ...
            >
              <div className="p-8 rounded-2xl bg-[#111118] border border-white/5">
                <h2 className="text-xl font-semibold mb-6">Mesaj Gonderin</h2>
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                  ...
                  >
                    ...
                    <option value="erp">ERP Danismanligi</option>
                    <option value="yazilim">Yazilim Gelistirme</option>
            ...
            >
              ...
              <div className="p-6 rounded-2xl bg-[#111118] border border-white/5">
                ...
                <p className="text-gray-400 text-sm">Turkiye</p>
