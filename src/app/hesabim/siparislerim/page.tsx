                ...
                <div key={order.id} className="p-5 rounded-2xl bg-[#111118] border border-white/5">
                  <div className="flex items-start justify-between gap-4 flex-wrap mb-4">
                    ...
                    <div className="text-right">
                      <p className="text-lg font-bold text-white">{order.totalPrice.toLocaleString("tr-TR")} {order.currency}</p>
                  ...
                  <div className="border-t border-white/5 pt-4 space-y-2">
                    {order.items.map((item, i) => (
                      <div key={i} className="flex justify-between items-center text-sm">
                        ...
                        <span className="text-gray-400 font-mono">{item.price.toLocaleString("tr-TR")} ₺</span>
                      </div>
                    ))}
                  </div>
                </div>
