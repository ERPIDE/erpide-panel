...
import { ArrowLeft, Copy, ExternalLink, Clock, ShoppingCart } from "lucide-react";
                      ...
                      <div className="flex gap-2">
                        {isTrial && (
                          <Link
                            ...
                            className="inline-flex items-center gap-1.5 text-sm px-4 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:opacity-90 transition"
                          >
