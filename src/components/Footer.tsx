    ...
    <footer className="border-t border-white/5 bg-[#08080d]">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-10">
          {/* Brand */}
          <div>
            <Link href="/" className="text-2xl font-bold gradient-text">ERPIDE</Link>
            <p className="text-gray-500 text-sm mt-3 leading-relaxed">
              Kurumsal ERP cozumleri ve yazilim danismanligi. Turkiye ve Kazakistan&apos;da hizmet veriyoruz.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link href="/hakkimizda" className="text-sm text-gray-400 hover:text-white transition">Hakkimizda</Link>
              <Link href="/iletisim" className="text-sm text-gray-400 hover:text-white transition">Iletisim</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <span className="text-sm text-gray-400">Ozel Yazilim</span>
              <span className="text-sm text-gray-400">Bakim ve Destek</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <span className="flex items-center gap-2 text-sm text-gray-400">
                <MapPin size={16} /> Turkiye &amp; Kazakistan
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 mt-12 pt-8 text-center">
          <p className="text-sm text-gray-600">
            &copy; 2024 ERPIDE YAZILIM A.S. — Tum Haklari Saklidir.
          </p>
        </div>
      </div>
    </footer>
