...
export const PRODUCTS: Product[] = [
  {
    ...
    skus: [
      ...
      // akisini rahatlatiyor, musteri de indirimi somut goruyor.
      {
        ...
        description: "Satış, satınalma, stok, cari, banka ve e-fatura — sınırsız kullanıcı · 2 ay bedava",
        price: 7490,
        currency: "TRY",
        cycle: "yearly",
        kind: "base",
        ...
        features: [
          ...
          "12 ay kullanım, 10 ay ödeme — 2 ay bedava",
        ...
        i18n: {
          en: {
            ...
            description: "Everything in Essential Commerce — unlimited users · 2 months free",
            features: ["Everything in Essential Commerce", "12 months for the price of 10", "Price locked for a year", "Unlimited users"],
          },
          ru: {
            name: "Базовая торговля — год",
            description: "Все из базового пакета — без ограничения пользователей · 2 месяца бесплатно",
            features: ["Все из базового пакета", "12 месяцев по цене 10", "Цена зафиксирована на год", "Неограниченное число пользователей"],
          },
          kk: {
            name: "Негізгі сауда — жылдық",
            description: "Негізгі пакеттегінің бәрі — шексіз пайдаланушы · 2 ай тегін",
            features: ["Негізгі пакеттегінің бәрі", "10 айдың бағасына 12 ай", "Жыл бойы баға тұрақты", "Шексіз пайдаланушы"],
          },
        },
      },
      {
        ...
        description: "Muhasebe, üretim ve personel dahil tam ERP — sınırsız kullanıcı · 2 ay bedava",
        price: 12490,
        currency: "TRY",
        cycle: "yearly",
        kind: "base",
        ...
        i18n: {
          en: {
            ...
            description: "Full ERP with accounting, manufacturing and payroll — unlimited users · 2 months free",
            features: ["Everything in Complete Commerce", "12 months for the price of 10", "Price locked for a year", "Unlimited users", "Priority support"],
          },
          ru: {
            name: "Полная торговля — год",
            description: "Полный ERP с бухгалтерией и производством — без ограничения пользователей · 2 месяца бесплатно",
            features: ["Все из полного пакета", "12 месяцев по цене 10", "Цена зафиксирована на год", "Неограниченное число пользователей", "Приоритетная поддержка"],
          },
          kk: {
            name: "Толық сауда — жылдық",
            description: "Бухгалтерия мен өндірісті қамтитын толық ERP — шексіз пайдаланушы · 2 ай тегін",
            features: ["Толық пакеттегінің бәрі", "10 айдың бағасына 12 ай", "Жыл бойы баға тұрақты", "Шексіз пайдаланушы", "Басым қолдау"],
          },
        },
      },
