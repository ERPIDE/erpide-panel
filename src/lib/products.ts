...
export const PRODUCTS: Product[] = [
  {
    ...
    skus: [
      ...
      // akisini rahatlatiyor, musteri de indirimi somut goruyor.
      {
        ...
        productId: "finanserpide",
        name: "İşletme — Yıllık",
        description: "Satış, satınalma, stok, cari, banka ve e-fatura — sınırsız kullanıcı · yıllık ödemede indirimli",
        price: 7490,
        currency: "TRY",
        cycle: "yearly",
        kind: "base",
        ...
        i18n: {
          en: {
            ...
            description: "Everything in the monthly Business plan — unlimited users · annual discount",
            features: ["Everything in the monthly Business plan", "Cheaper than paying monthly", "Price locked for a year", "Unlimited users"],
          },
          ru: {
            name: "Бизнес — год",
            description: "Все из базового пакета — без ограничения пользователей · годовая скидка",
            features: ["Все из базового пакета", "Дешевле помесячной оплаты", "Цена зафиксирована на год", "Неограниченное число пользователей"],
          },
          kk: {
            name: "Бизнес — жылдық",
            description: "Негізгі пакеттегінің бәрі — шексіз пайдаланушы · жылдық жеңілдік",
            features: ["Негізгі пакеттегінің бәрі", "Айлық төлемнен арзан", "Жыл бойы баға тұрақты", "Шексіз пайдаланушы"],
          },
        },
      },
      {
        ...
        description: "Muhasebe, üretim ve personel dahil tam ERP — sınırsız kullanıcı · yıllık ödemede indirimli",
        price: 12490,
        currency: "TRY",
        cycle: "yearly",
        kind: "base",
        ...
        i18n: {
          en: {
            ...
            description: "Full ERP with accounting, manufacturing and payroll — unlimited users · annual discount",
            features: ["Everything in the monthly Enterprise plan", "Cheaper than paying monthly", "Price locked for a year", "Unlimited users", "Priority support"],
          },
          ru: {
            name: "Корпоративный — год",
            description: "Полный ERP с бухгалтерией и производством — без ограничения пользователей · годовая скидка",
            features: ["Все из полного пакета", "Дешевле помесячной оплаты", "Цена зафиксирована на год", "Неограниченное число пользователей", "Приоритетная поддержка"],
          },
          kk: {
            name: "Корпоративтік — жылдық",
            description: "Бухгалтерия мен өндірісті қамтитын толық ERP — шексіз пайдаланушы · жылдық жеңілдік",
            features: ["Толық пакеттегінің бәрі", "Айлық төлемнен арзан", "Жыл бойы баға тұрақты", "Шексіз пайдаланушы", "Басым қолдау"],
          },
        },
      },
